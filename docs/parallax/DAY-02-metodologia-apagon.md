...
Commits (rebased onto `7b5e4e1e`): `bfa36c3e` STEP 0 · `7f7de3ce` Changes 1–8 · `d7374f51` judge fixes · docs + BUILD_ID `2026-09-18-parallax-d2-metodologia-apagon` (see PARALLAX.md row 2). Bundle + served-string verification recorded in PARALLAX.md at deploy.
