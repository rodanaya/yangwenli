...
Shipped 2026-09-22 09:47Z: origin/main + VPS HEAD `d4f8e619`, BUILD_ID `2026-09-22-parallax-d5b-casos-ink`, entry `index-7skM2pEI.js` → `index-CBrinQGr.js`, verified on the live Oceanografía dossier (charge reads "the only conviction in 43 documented cases", § numerals computed `rgb(133, 77, 14)` = `#854d0e`), health OK (3,058,286 contracts).
