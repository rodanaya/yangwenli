...
class TestConfidenceIntervals:
    ...
    @pytest.mark.skip(
        reason="CI columns (risk_confidence_lower/upper) still contain v5.2 bootstrap values. "
               "Re-enable after running calculate_risk_scores_v5 to recompute CIs for v5.1 scores."
    )
