...
# NOTE: GET /quadrant/{quadrant} removed 2026-06-11 — the contradiction-quadrant
# drill-down page was retired (folded into /methodology); zero callers, no test.
# /intersection/summary is the only live intersection endpoint.
