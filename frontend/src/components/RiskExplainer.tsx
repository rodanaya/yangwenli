...
export const FACTOR_EXPLANATIONS: Record<string, FactorExplanation> = {
  vendor_concentration: {
    ...
    rubli_note:
      "Strong predictor globally in v0.8.5 (+0.238). Expanded ground truth (1,424 cases, 861 vendors) reveals market concentration remains a significant signal across diverse corruption types.",
  },
  price_volatility: {
    ...
    rubli_note:
      'Top global predictor in v0.8.5 (+1.857). Remains strongest across 1,424 documented cases. Vendors with wildly varying contract amounts relative to sector norms consistently scored highest.',
  },
  ...
  sector_spread: {
    ...
    citation: 'RUBLI v0.8.5 ground truth analysis (1,424 institution-scoped cases)',
    rubli_note:
