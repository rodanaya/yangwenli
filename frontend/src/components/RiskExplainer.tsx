...
export const FACTOR_EXPLANATIONS: Record<string, FactorExplanation> = {
  vendor_concentration: {
    ...
    rubli_note:
      "Strong predictor globally in v0.8.5 (+0.238). Expanded ground truth (1,417 cases, 1,554 vendors) reveals market concentration remains a significant signal across diverse corruption types.",
  },
  price_volatility: {
