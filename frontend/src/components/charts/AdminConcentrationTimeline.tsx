...
function AdminConcentrationTimeline({
  ...
  const kicker = lang === 'en' ? 'RUBLI · MARKET CONCENTRATION' : 'RUBLI · CONCENTRACIÓN DE MERCADO'
  const source = lang === 'en'
    ? 'Source: RUBLI analysis · COMPRANET 2002–2024 · top-vendor share by sector'
    : 'Fuente: análisis RUBLI · COMPRANET 2002–2024 · participación del proveedor principal por sector'
