...
<body>
  ...
  <div class="disclaimer">
    <strong>Disclaimer:</strong> Generated by RUBLI v6.5 — Risk scores are statistical indicators, not proof of corruption.
          ...
          {data && (
            <div className="space-y-4 text-sm">
              ...
              <div className="rounded-md bg-background-elevated p-3 text-xs text-text-muted border border-border/40">
                ...
                v6.5 — Risk scores are statistical indicators, not proof of corruption.
              </div>
            </div>
          )}
        </div>
