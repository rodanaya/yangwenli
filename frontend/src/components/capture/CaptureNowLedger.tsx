...
export function CaptureNowLedger({
  ...
  return (
    <section className="mt-12">
      ...
      >
        {/* "HHI · último año" is two characters longer than "HHI · latest yr";
            without the extra room the Spanish header wraps and drops its sort
            arrow onto a second line. The column is hidden below md, so the
            wider floor starts there. */}
        <table
          className={`w-full table-fixed text-[13px] min-w-[760px] lg:min-w-0 ${lang === 'es' ? 'md:min-w-[848px]' : 'md:min-w-[824px]'}`}
        >
          ...
          <colgroup>
            ...
            <col style={{ width: 168 }} />
            <col style={{ width: 112 }} />
            <col className="hidden md:table-column" style={{ width: lang === 'es' ? 192 : 168 }} />
          </colgroup>
          <thead>
