...
const INFOGRAPHICS: Infographic[] = [
  ...
  },
  {
    ...
    title_es: 'Distribución de Riesgo: 334,066 Contratos de Alto Riesgo',
    title_en: 'Risk Distribution: 334,066 High-Risk Contracts',
    caption_es:
      'De 3.05 millones de contratos federales, 334,066 (10.95%) presentan patrones de alto o crítico riesgo de corrupción según el modelo RUBLI v0.8.5 — entrenado con 1,427 casos documentados.',
    caption_en:
      'Of 3.05 million federal contracts, 334,066 (10.95%) show high or critical corruption risk patterns per the RUBLI v0.8.5 model — trained on 1,427 documented cases.',
