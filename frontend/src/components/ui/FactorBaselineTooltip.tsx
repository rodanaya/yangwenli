...
const FACTOR_LABELS: Record<string, string> = {
  ...
  vendor_concentration: 'Concentracion de Proveedor',
  price_ratio: 'Ratio de Precio',
  network_member_count: 'Red de Co-contratacion',
  same_day_count: 'Contratos Mismo Dia',
  single_bid: 'Licitacion Unica',
  ad_period_days: 'Periodo de Publicacion',
  win_rate: 'Tasa de Adjudicacion',
  direct_award: 'Adjudicacion Directa',
  sector_spread: 'Diversificacion Sectorial',
  co_bid_rate: 'Tasa de Co-licitacion',
  price_hyp_confidence: 'Anomalia de Precio',
  year_end: 'Fin de Ano',
