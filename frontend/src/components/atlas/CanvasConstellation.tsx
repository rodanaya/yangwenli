...
// can't even navigate." The 150-LOC `drawPatternGlyph` helper is preserved
// in git history at commit `74e0b740` — revive if a future design lands
// on per-pattern decoration.
