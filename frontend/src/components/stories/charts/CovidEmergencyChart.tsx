    ...
    >
      ...
      <div className="flex items-center gap-4 mt-2">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[12px] font-mono text-text-muted">{t('covidEmergency.daSeries')}</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="h-2 w-2 rounded-full" style={{ background: 'var(--color-sector-trabajo)' }} aria-hidden="true" />
          <span className="text-[12px] font-mono text-text-muted">{t('covidEmergency.singleBidSeries')}</span>
        </div>
      </div>
    </EditorialChartFrame>
  )
