  ...
  return (
    ...
    >
      ...
      >
        ...
        {[40, 80, 120, 160].map((v) => (
          <g key={`yg-${v}`}>
            <line x1={PAD.left} x2={W - PAD.right} y1={yFor(v)} y2={yFor(v)} stroke="#27272a" strokeDasharray="2 4" />
        ...
        {[60, 70, 80].map((v) => (
          <g key={`xg-${v}`}>
            <line x1={xFor(v)} x2={xFor(v)} y1={PAD.top} y2={H - PAD.bottom} stroke="#27272a" strokeDasharray="2 4" />
