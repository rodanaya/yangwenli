    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="border-l-2 border-red-500 pl-3 py-1">
          <div className="text-xl font-mono font-bold text-risk-critical">+64%</div>
          <div className="text-[10px] text-text-muted uppercase tracking-wide mt-0.5">
            December risk vs. October baseline
          </div>
        </div>
        <div className="border-l-2 border-amber-500 pl-3 py-1">
          <div className="text-xl font-mono font-bold text-risk-high">MXN 4.87M</div>
          <div className="text-[10px] text-text-muted uppercase tracking-wide mt-0.5">
      ...
      <p className="text-[10px] text-text-muted">
        Source: COMPRANET 2002-2025 · 3.05M contracts · RUBLI v0.8.5 risk scores
      </p>
    </motion.div>
  )
}
