    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-5 lg:grid-cols-[1.4fr_1fr] items-start">
        <div className="space-y-3">
          <div>
            <div className="font-mono flex items-baseline justify-between mb-1.5" style={{ fontSize: 12, letterSpacing: '0.08em', color: 'var(--color-text-secondary)' }}>
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1.5 pt-1">
            {pb.map((p) => (
              <div key={p.type} className="flex items-center gap-1.5 font-mono" style={{ fontSize: 13, color: 'var(--color-text-muted)' }}>
      ...
      {drift.length > 1 && (
        <div>
          <div className="font-mono mb-1.5" style={{ fontSize: 13, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--color-text-muted)' }}>
        ...
        {pats.slice(0, 6).map((p) => {
          ...
          return (
            <div key={p.pattern} className="flex items-center gap-3">
              ...
              <span className="shrink-0 text-right font-mono tabular-nums" style={{ fontSize: 13, color: 'var(--color-text-secondary)', width: 88 }}>
        ...
        return (
          <div key={r.subcategory_id}>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="shrink-0 font-mono tabular-nums" style={{ fontSize: 13, color: 'var(--color-text-muted)', width: 88, textAlign: 'right' }}>
  ...
  if (isLoading) {
    return (
      <div className="space-y-2" aria-live="polite">
        ...
        <p className="font-mono" style={{ fontSize: 12, color: 'var(--color-text-muted)' }}>{t(lang, 'Consultando… puede tardar.', 'Querying… may take a moment.')}</p>
      </div>
    )
  }
          ...
          <li key={r.contract_id} className="flex gap-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-baseline justify-between gap-3">
                ...
                <span className="shrink-0 flex items-baseline gap-2.5 font-mono tabular-nums" style={{ fontSize: 12, color: 'var(--color-text-muted)' }}>
