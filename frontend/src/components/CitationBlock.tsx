...
const APA = `RUBLI Project. (2026). RUBLI: Mexican Federal Procurement Intelligence Platform (v0.8.5). Retrieved from ${APP_URL}`

const PLAIN = `Source: RUBLI Procurement Intelligence Platform (v0.8.5, 2026). Data from COMPRANET (SHCP), 3.1 million federal contracts 2002–2025. Risk scores are statistical similarity indicators, not legal determinations. Methodology: ${APP_URL}/methodology`
