    ...
    chapters: [
      ...
      },
      {
        ...
        chartConfig: {
          ...
          data: {
            points: [
              { label: 'Operadora CICSA',         value: 139.0, color: '#dc2626', highlight: true,  annotation: '5 contracts · risk 0.36' },
              { label: 'Mantenimiento Express',   value: 69.9,  color: '#dc2626', highlight: true,  annotation: '1 contract · risk 1.00' },
              { label: 'Dowell Schlumberger',     value: 64.8,  color: '#a06820',                    annotation: '9 contracts · risk 0.97' },
              { label: 'Grupo Fármacos',          value: 62.9,  color: '#dc2626', highlight: true,  annotation: '29 contracts · risk 0.99' },
              { label: 'Urbanissa',                value: 58.0,  color: '#dc2626', highlight: true,  annotation: '1 contract · risk 0.97' },
              { label: 'ICA Constructora',         value: 41.8,  color: '#a06820',                    annotation: '3 contracts · risk 0.65 · Tren Maya' },
              { label: 'Alstom Transport',         value: 37.9,  color: '#a06820',                    annotation: '2 contracts · risk 0.92 · Tren Maya' },
              { label: 'Constructora Arhnos',      value: 31.9,  color: '#dc2626', highlight: true,  annotation: '1 contract · risk 1.00' },
              { label: 'ICA Fluor Daniel',         value: 31.2,  color: '#a06820',                    annotation: '6 contracts · risk 1.00' },
              { label: 'Grupo Constructor Marhnos',value: 28.0,  color: '#a06820',                    annotation: '2 contracts · risk 0.37' },
              { label: 'Repsol Exploración',       value: 27.2,  color: '#a06820',                    annotation: '1 contract · risk 1.00' },
              { label: 'Mota-Engil México',        value: 25.8,  color: '#a06820',                    annotation: '4 contracts · risk 0.95' },
            ],
            unit: 'B MXN',
      ...
      },
      {
        ...
        chartConfig: {
          ...
          data: {
            points: [
              { label: 'Energía',          value: 917.3, color: '#eab308', highlight: true, annotation: '34.5% · 250 contracts' },
              { label: 'Salud',            value: 638.6, color: '#dc2626', highlight: true, annotation: '24.0% · 258 contracts' },
              { label: 'Infraestructura',  value: 552.4, color: '#ea580c', highlight: true, annotation: '20.8% · 100 contracts' },
              { label: 'Hacienda',         value: 349.6, color: '#16a34a',                  annotation: '13.1% · 92 contracts' },
              { label: 'Educación',        value: 52.9,  color: '#3b82f6',                  annotation: '2.0%' },
              { label: 'Medio Ambiente',   value: 51.1,  color: '#10b981',                  annotation: '1.9%' },
              { label: 'Gobernación',      value: 47.1,  color: '#be123c',                  annotation: '1.8%' },
              { label: 'Defensa (civil)',  value: 24.9,  color: '#1e3a5f',                  annotation: '0.9% (mil. via separate channels)' },
              { label: 'Agricultura',      value: 12.4,  color: '#22c55e',                  annotation: '0.5%' },
              { label: 'Trabajo',          value: 6.2,   color: '#f97316',                  annotation: '0.2%' },
            ],
            unit: 'B MXN',
    ...
    chapters: [
      ...
      },
      {
        ...
        chartConfig: {
          ...
          stacked: {
            rows: [
              { label: 'Salud',           total: 1201.4, highlight: 1201.4, annotation: '+47% vs Peña' },
              { label: 'Infraestructura', total: 326.4,  highlight: 326.4,  annotation: '−65% vs Peña' },
              { label: 'Hacienda',        total: 392.9,  highlight: 392.9,  annotation: '+70% vs Peña' },
              { label: 'Defensa',         total: 168.9,  highlight: 168.9,  annotation: '+186% vs Peña' },
              { label: 'Gobernación',     total: 190.4,  highlight: 190.4,  annotation: '+100% vs Peña' },
              { label: 'Agricultura',     total: 166.2,  highlight: 166.2,  annotation: '+36% vs Peña' },
              { label: 'Educación',       total: 114.9,  highlight: 114.9,  annotation: '−26% vs Peña' },
              { label: 'Medio Ambiente',  total: 94.2,   highlight: 94.2,   annotation: '−31% vs Peña' },
              { label: 'Energía',         total: 50.1,   highlight: 50.1,   annotation: '−88% vs Peña' },
            ],
            unit: 'B MXN',
            anchor: { value: '2.76T MXN', label: 'AMLO TOTAL FEDERAL PROCUREMENT, 2019-2024' },
            ...
            series: [
              {
                ...
                annotation: { xIndex: 9, text: '22.43B (5.4% of fed)' },
      ...
      },
      {
        ...
        chartConfig: {
          ...
          data: {
            points: [
              { label: 'Medicamentos',        value: 327.6, color: '#dc2626', highlight: true,  annotation: '22.4% hi-risk' },
              { label: 'Construcción Edif.', value: 269.4, color: '#a06820',                    annotation: '8.5% hi-risk' },
              { label: 'Servicios Generales', value: 245.7, color: '#a06820',                    annotation: '14.3% hi-risk' },
              { label: 'Material Curación',   value: 228.1, color: '#a06820',                    annotation: '12.1% hi-risk' },
              { label: 'Alimentos y Víveres', value: 224.9, color: '#dc2626', highlight: true,  annotation: '32.4% hi-risk' },
              { label: 'Mantenimiento',       value: 177.2, color: '#a06820',                    annotation: '9.4% hi-risk' },
              { label: 'Servicios Hospital.', value: 164.4, color: '#dc2626', highlight: true,  annotation: '19.4% hi-risk' },
              { label: 'Carreteras',          value: 105.0, color: '#a06820',                    annotation: '12.2% hi-risk' },
            ],
            unit: 'B MXN',
