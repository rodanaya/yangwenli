        ...
        chartConfig: {
          ...
          data: {
            points: [
              {
                label: 'SAT · best case',
                label_es: 'SAT · escenario óptimo',
                value: 6,
                annotation: 'months to definitive listing',
                annotation_es: 'meses hasta listado definitivo',
              },
              {
                label: 'SAT · typical',
                label_es: 'SAT · plazo típico',
                value: 15,
                annotation: '12–18 months to definitive listing',
                annotation_es: '12–18 meses hasta listado definitivo',
              },
              {
                ...
                annotation_es: '36+ meses (impugnaciones legales)',
              },
              {
                label: 'RUBLI · P2 algorithm',
                label_es: 'RUBLI · algoritmo P2',
                value: 0.5,
                highlight: true,
                annotation: '~2 weeks per pipeline run',
                annotation_es: '~2 semanas por corrida del pipeline',
              },
            ],
            unit: 'months',
            maxValue: 40,
            annotation: 'Estimated process duration — months to definitive Art. 69-B listing versus a single ARIA P2 pipeline run. During SAT\'s window, flagged vendors keep contracting. Source: OECD 2023 Public Procurement Performance Report.',
            annotation_es: 'Duración estimada del proceso — meses hasta listado definitivo bajo el Art. 69-B frente a una sola corrida del pipeline P2 de ARIA. Durante la ventana del SAT, los proveedores marcados siguen contratando. Fuente: OCDE, Reporte de Desempeño en Contrataciones Públicas 2023.',
          },
        },
        sources: [
