...
export const STORIES: StoryDef[] = [
    ...
    chapters: [
      ...
      },
      {
        ...
        prose: [
          ...
          "RUBLI quantifies the gap. 819 billion pesos of contracting in the above-10-billion tier; 33 vendors; risk average 0.962; an estimated 95 percent of contracts above 5 billion pesos never audited, against an estimated 5 percent audit coverage rate. Closing it needs no new laws and no new technology — only naming the 33 vendors and the 40 contracts and assigning each to a specific investigation, regardless of which ministry signed.",
        ],
        prose_es: [
    ...
    chapters: [
      {
        ...
        prose: [
          "Over fourteen years, RUBLI counts more than 800,000 Mexican federal procedures that were run as competitive and drew exactly one bid. Each one met the legal requirement for competitive sourcing on paper. Each was a predetermined award dressed as an open contest.",
        ...
        prose_es: [
          "En catorce años, RUBLI cuenta más de 800,000 procedimientos federales mexicanos que se corrieron como competitivos y atrajeron exactamente una oferta. Cada uno cumplió en el papel con el requisito legal de contratación competitiva. Cada uno fue una adjudicación predeterminada disfrazada de concurso abierto.",
      ...
      },
      {
        ...
        subtitle_es: "Cada paso es legal, que es justo por qué ninguna institución puede tocarlo",
        prose: [
  ...
  // === STORY 6: High Water ===
  {
    ...
    leadStat: {
      value: '+5.1pp',
      label: "the drift in the direct-award rate since the Fox baseline, across four administrations",
      label_es: "la deriva de la tasa de adjudicación directa desde la línea base Fox, en cuatro administraciones",
    ...
    chapters: [
      ...
      },
      {
        ...
        prose_es: [
          ...
          "Los 130.6 mil millones de energía corren por PEMEX Exploración y Producción y la CFE. Aquí los suministradores reales suelen ser internacionales — Schlumberger, Siemens, GE — alcanzados a través de socios locales de intermediación. La sobreposición es localización legítima o pura extracción de renta, y solo el análisis a nivel contrato distingue una de otra.",
      ...
      },
      {
        ...
        prose_es: [
          ...
          "Este flujo tiene un prototipo documentado. La Estafa Maestra pasó dependencias federales por universidades públicas, que subcontrataban con empresas fantasma, que devolvían el dinero a los funcionarios que lo originaron. La investigación parlamentaria de 2017 y la de MCCI/Animal Político encontraron 7.67 mil millones de pesos movidos por la estructura solo en 2013–2014. Funcionó porque el Art. 1, último párrafo de la Ley de Adquisiciones exime de licitación competitiva a los contratos con universidades. La base de verdad-base de RUBLI carga el caso; los proveedores directamente vinculados puntúan de 0.55 a 0.65.",
  ...
  // === STORY 9: A Line in the Law, and the Crowd Beneath It ===
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        prose: [
          "DICONSA awarded 985 suspicious clusters — three or more contracts to the same vendor, on the same day, each in the 195K-305K threshold band — 3,395 split contracts worth 829.6 million pesos. Count those clusters across every federal institution and the roster sharpens the story the histogram only suggests. Its renamed successor, Alimentación para el Bienestar, adds 230 clusters and 869 contracts (214.2M MXN). Both move bulk staples against a thin oversight surface — large recurrent buying, a mechanism distinct from day-of splitting.",
        ...
        prose_es: [
          "DICONSA adjudicó 985 cúmulos sospechosos — tres o más contratos al mismo proveedor, el mismo día, cada uno en la banda umbral de 195K-305K — 3,395 contratos divididos por 829.6 millones de pesos. Cuenta esos cúmulos en cada institución federal y el padrón afila la historia que el histograma apenas sugiere. Su entidad sucesora renombrada, Alimentación para el Bienestar, suma 230 cúmulos y 869 contratos (214.2 M MXN). Ambas mueven productos básicos a granel contra una superficie de fiscalización delgada — compra grande y recurrente, un mecanismo distinto del fraccionamiento del mismo día.",
      ...
      },
      {
        ...
        prose: [
          ...
          "What is missing is will, not capability. RUBLI's clustering detection already hands investigators a target list: units firing 20 contracts of exactly 300,000 pesos in a week, vendors that live only in threshold-adjacent awards. The remedies are well-established — automatic threshold-adjacency flagging at data entry, mandatory explanation when same-vendor same-day awards aggregate above the line, algorithmically prioritized SFP audits, and aggregation rules that treat a series of related contracts as one procurement, exactly what the EU's Directive 2014/24/EU requires in Art. 5 and Mexican law has not fully adopted, though Art. 17 already supplies the prohibition. CompraNet holds every byte needed. The spikes at 210K, 250K and 300K are printed in public data for anyone able to read them. The question is no longer whether this happens at scale — it does — but when Mexican institutions will act on a number they can already see.",
        ],
        prose_es: [
    ...
    chapters: [
      ...
      },
      {
        ...
        prose: [
          ...
          "This is a structural verdict spanning five administrations and 23 years. Each one inherits its predecessor's direct-award rate; none has delivered a sustained cut; the floor has never fallen below 60% against an OECD target of 15-20%. By that measure, 2020 is not an anomaly. It is the cleanest reading the data offers of a system whose default is non-competition.",
    ...
    chapters: [
      {
        ...
        prose: [
          ...
          "The size is not the scandal. A federal market can be large and still be open; 240 billion pesos is unremarkable on its own. What is remarkable is how the contracts are awarded. Edenred wins 96.7 percent of its federal contracts by direct award — 2,210 contracts, every one of them entered through IMSS direct award, with no tender to win or lose. Efectivale's direct-award rate is 92.4 percent; Sodexo's is 88.1. All three sit above 88 against an OECD ceiling of 30, the line past which a market has stopped competing.",
      ...
      },
      {
        ...
        prose: [
          "The market stays closed through two mechanisms that work in sequence. The first is the bypass. Edenred's 96.7 percent direct-award rate means the competitive process almost never opens — 2,210 contracts, every one awarded through IMSS direct award. When the buyer can skip the open tender, the question of who else might have competed never arises. The bypass is blunt, visible, and entirely legal.",
