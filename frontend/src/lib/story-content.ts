  ...
  // =========================================================================
  {
    ...
    chapters: [
      // ── Ch 1: La pistola humeante ──────────────────────────────────────────
      {
        ...
        prose: [
          'El modelo de riesgo v0.8.5 de RUBLI fue entrenado contra 1,378 proveedores documentados en casos de corrupción — redes de empresas fantasma del IMSS, fraude de Segalmex, irregularidades COVID, La Estafa Maestra universitaria. El proceso usó regresión logística ElasticNet con 200 ensayos de optimización bayesiana (Optuna). Tenía 18 variables candidatas y libertad total para ponderarlas según los datos.',
