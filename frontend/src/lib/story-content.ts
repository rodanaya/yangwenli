  ...
  // === STORY 1: The Man Who Won 370 Million Pesos and Disappeared ===
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        prose: [
          "The flagged vendor has a name in the record — Emilio Carranza Obersohn. The official who signed his two contracts does not. A ghost company is a two-sided transaction: someone creates the shell, and someone inside the government signs the approval. The record names only the first half. Across the register, RUBLI's cross-reference matches only 99 of the flagged vendor population to an SFP sanction — a tiny fraction of the 6,118 P2-flagged vendors — and the sanctions record names almost none of the approving officials. The chart's zero bar is that absence itself: vendors are sanctioned, and almost none of the officials who approved them are named or sanctioned.",
