    ...
    chapters: [
      {
        ...
        prose_es: [
          'El modelo de riesgo v0.8.5 de RUBLI califica cada contrato federal en una escala de 0 a 1 calibrada contra 1,417 casos documentados de corrupción. El modelo desconoce el tamaño del contrato al asignar las calificaciones — procesa características como concentración de proveedores, volatilidad de precios y mecanismo de contratación. Sin embargo, cuando los contratos se agrupan por tamaño después de la calificación, la relación entre tamaño y riesgo es casi monótona.',
    ...
    chapters: [
      {
        ...
        prose: [
          'RUBLI\'s v0.8.5 risk model was not calibrated to any single administration. It was trained on 1,417 documented corruption cases spanning multiple presidencies and scores contracts based on their structural similarity to known-bad patterns: vendor concentration, price volatility, single-bidder conditions, network membership, institution diversity, and procurement mechanism. The model has no partisan attachment and no political knowledge. It sees only patterns.',
  ...
  // =========================================================================
  {
    ...
    chapters: [
      // ── Ch 1: La pistola humeante ──────────────────────────────────────────
      {
        ...
        prose: [
          'El modelo de riesgo v0.8.5 de RUBLI fue entrenado contra 861 proveedores documentados en casos de corrupción — redes de empresas fantasma del IMSS, fraude de Segalmex, irregularidades COVID, La Estafa Maestra universitaria. El proceso usó regresión logística ElasticNet con 200 ensayos de optimización bayesiana (Optuna). Tenía 18 variables candidatas y libertad total para ponderarlas según los datos.',
        ...
        pullquote: {
          quote: 'De 18 variables candidatas, el algoritmo eligió price_volatility sin que nadie se lo pidiera. Esa elección es el juicio del modelo sobre qué tienen en común 861 casos de corrupción documentada.',
          quote_es: 'De 18 variables candidatas, el algoritmo eligió price_volatility sin que nadie se lo pidiera. Esa elección es el juicio del modelo sobre qué tienen en común 861 casos de corrupción documentada.',
          stat: '+0.558',
      ...
      // ── Ch 4: Dos algoritmos convergen ────────────────────────────────────
      {
        ...
        prose: [
          'RUBLI corre dos capas analíticas independientes. La primera es el modelo supervisado v0.8.5: regresión logística entrenada contra 861 casos de corrupción documentada. La segunda es una capa de detección de anomalías no supervisada usando PyOD IForest — un algoritmo de isolation forest que no usa etiquetas de corrupción en absoluto. IForest solo detecta contratos que son estadísticamente inusuales respecto al universo de 3.1 millones.',
    ...
    chapters: [
      {
        ...
        chartConfig: {
          type: 'inline-bar',
          title: 'Direct Award Rate by Year — 2015–2024',
          title_es: 'Tasa de adjudicación directa por año — 2015–2024',
          ...
          data: {
            points: [
              ...
              { label: '2019', value: 72.3 },
              { label: '2020', value: 87.0, highlight: true, annotation: 'COVID emergency', annotation_es: 'Emergencia COVID' },
              { label: '2021', value: 81.2 },
              { label: '2022', value: 79.4 },
              { label: '2023', value: 82.2 },
              { label: '2024', value: 80.1 },
            ],
            yLabel: '% Direct Award',
            yLabel_es: '% Adjudicación Directa',
            annotation: '2020 peak: 87% — 14.7pp above 2019 pre-COVID baseline',
            annotation_es: 'Pico 2020: 87% — 14.7pp sobre la línea base pre-COVID de 2019',
          },
        },
        pullquote: {
    ...
    chapters: [
      {
        ...
        chartConfig: {
          type: 'inline-bar',
          title: 'Voucher Market — Direct Award Rate by Vendor',
          title_es: 'Mercado de vales — Tasa de adjudicación directa por proveedor',
          chartId: 'vales-da-rate',
          data: {
            points: [
              { label: 'Edenred', value: 96.7, highlight: true, annotation: '2,210 contracts · P5', annotation_es: '2,210 contratos · P5' },
              { label: 'Efectivale', value: 92.4, highlight: true, annotation: '2,210 single-bid · 19.6B', annotation_es: '2,210 oferta única · 19.6 mil M' },
              { label: 'Sodexo', value: 88.1, annotation: '658 single-bid · 5.2B', annotation_es: '658 oferta única · 5.2 mil M' },
              { label: 'Others', value: 45.2 },
            ],
            yLabel: '% Direct Award',
            yLabel_es: '% Adjudicación Directa',
            annotation: 'Top 3 vendors capture 93% of federal voucher spend.',
            annotation_es: 'Los 3 principales capturan el 93% del gasto federal en vales.',
          },
        },
        pullquote: {
