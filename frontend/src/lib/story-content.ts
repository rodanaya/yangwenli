    ...
    chapters: [
      {
        ...
        prose: [
          'RUBLI\'s v0.8.5 risk model was not calibrated to any single administration. It was trained on 1,401 documented corruption cases spanning multiple presidencies and scores contracts based on their structural similarity to known-bad patterns: vendor concentration, price volatility, single-bidder conditions, network membership, institution diversity, and procurement mechanism. The model has no partisan attachment and no political knowledge. It sees only patterns.',
