...
export const STORIES: StoryDef[] = [
  ...
  // =========================================================================
  {
    ...
    subheadline: 'The promise to end corruption arrived alongside the highest rate of direct awards in 23 years of federal data',
    byline: 'RUBLI · Data Analysis Unit',
    estimatedMinutes: 12,
    leadStat: { value: '81.9%', label: 'contracts without competitive bidding in 2023', sublabel: 'the highest rate since 2002', color: 'text-red-500' },
    status: 'reporteado',
    nextSteps: [
    ...
    chapters: [
      {
        ...
        sources: [
          'COMPRANET — Federal contract database 2002-2025 (3,051,294 records).',
          'OECD (2023). Public Procurement Performance Report. OECD Publishing, Paris.',
          'DOF, December 1, 2018 — Republican Austerity Decree, Art. 3-5.',
          'RUBLI v6.5 — Risk model, 150 Optuna trials, AUC=0.828.',
        ],
        prose: [
          'Palacio Nacional, December 1, 2018. Andrés Manuel López Obrador takes the presidential sash and delivers the words that will define his government: the Fourth Transformation will end corruption. No more kickbacks. No more shell companies. No more fixed contracts. Transparency in public spending will be the cornerstone of the new regime.',
          'Exactly twelve months passed. In 2019 — without a pandemic, without a natural disaster, without a single declared emergency to justify skipping public bidding — 77.8% of all federal contracts were awarded directly. It was, at that point, the highest rate since COMPRANET began tracking federal government purchases in 2002. The first full year of the anti-corruption administration had already broken the opacity record.',
          'But 2019 was only the starting point. Each subsequent year surpassed the last: 78.1% in 2020, 80.0% in 2021, 79.1% in 2022, and finally 81.9% in 2023. There was no isolated spike, no explainable stumble. The curve rose without exception for six consecutive years, with the consistency of deliberate policy, not accident.',
        ],
        pullquote: {
      ...
      },
      {
        ...
        prose: [
          'There is an argument that government defenders repeated for six years: the pandemic forced emergency purchases. It is a convenient explanation. It is also false. The record year for direct awards was not 2020, when COVID-19 paralyzed hospitals and supply chains. It was 2023 — a year without a health crisis, without a declared economic emergency, without any legal justification for bypassing competitive bidding. That year, eighty-two cents of every federal contracting peso went to companies that never had to compete for it.',
          'The staircase was methodical: 77.8% in 2019, 78.1% in 2020, 80.0% in 2021, a slight dip to 79.1% in 2022, and the final leap to 81.9% in 2023. The pandemic does not explain the trend because the trend existed before the pandemic. And continued after it.',
          'The historical contrast is instructive. Under Felipe Calderón, in 2010, the direct award rate was 62.7% — already high by any international standard, but 19 points below what López Obrador would leave when he handed over power. Under Peña Nieto, widely implicated in the Casa Blanca scandal and Odebrecht bribes, the rate climbed from 68.4% to 76.2%. López Obrador inherited that legacy and surpassed it every single year. No president since COMPRANET has existed contracted with such opacity.',
        ],
        chartConfig: {
          type: 'da-trend',
          highlight: '2023',
      ...
      },
      {
        ...
        prose: [
          'At the morning press conference on March 14, 2019, López Obrador offered an explanation he would repeat dozens of times: direct awards were necessary because competitive bids had been rigged. Better to buy direct, he said, than to stage contests where the same company always won. The argument had seductive logic. It also had a problem: the sectors where direct awards were used most were not the technically most complex — they were the ones handling the most money.',
          'Agriculture — the sector of SEGALMEX, the scandal that consumed the administration — reached a 93.4% direct award rate. Nine out of ten contracts to buy milk, corn and beans for food assistance programs were handed out without competition. There was no technical urgency in buying tortillas. No need for a single supplier to distribute rice. What existed was a system where intermediaries collected and beneficiaries received nothing.',
          'In Health, the rate reached 78.9% during the worst years of medicine shortages the country had experienced in decades. The government dismantled the existing pharmaceutical distribution chain, arguing it was rotten with corruption. It replaced it with direct awards through BIRMEX and then IMSS-Bienestar. Hospitals ran out of insulin, chemotherapy, antiretrovirals. Opacity did not solve the shortage. It caused it.',
          'The emergency argument collapses when examined sector by sector. The emergency was not in the fields or in SEGALMEX warehouses. It was in the political will to evade competition.',
        ],
        pullquote: {
      ...
      },
      {
        ...
        prose: [
          'In South Korea, 5% of public contracts are awarded without competition. In Chile, 12%. In France, 18%. The OECD sets the alarm threshold at 25% — a limit that most of its members do not even approach. Mexico under López Obrador tripled that mark: 81.9% in 2023. There is no OECD member, or aspiring member, that has operated with that proportion of opacity in its public spending.',
          'Peña Nieto — a government stained by the Casa Blanca of Angélica Rivera and Odebrecht bribes — left the rate at 76.2%. López Obrador promised to lower it. He raised it by 5.7 points. In a system that moves trillions of pesos annually, each percentage point represents tens of thousands of contracts shifted from competition to discretion. The 2,493,117 direct contracts of the administration total more than 2 trillion pesos.',
          'Among those millions of contracts, one figure deserves separate attention: 1,253 companies were founded after December 2018, without a single prior federal contract, and obtained more than 95% of their contracts through direct award during the 4T. They appeared with the new government and fed exclusively on no-bid purchases. The promise was to eliminate shell companies. What happened was that new ones were born.',
          'The uncomfortable question is not whether there was opacity. That is already answered in COMPRANET records. The question is why a government that made transparency its banner deliberately reduced it, year after year, until it set a record that neither Peña Nieto, nor Calderón, nor Fox had reached.',
        ],
        pullquote: {
          quote: 'Mexico under AMLO: 3x the OECD limit on direct awards',
          stat: '3.3x',
          statLabel: '81.9% vs 25% recommended by OECD',
          barValue: 82,
      ...
      },
      {
        ...
        prose: [
          'Every contract the federal government signed since 2002 is recorded in COMPRANET, the public database of the Finance Ministry. That is 3,051,294 records — with amounts, dates, vendors, procedure type and contracting agency. Any journalist with internet access can download them. The raw material for a dozen investigations is there, waiting.',
          'The first question for any investigation is the institution. An agency that directly awarded 95% of its contracts for four consecutive years deserves a freedom-of-information request for every contract over 50 million pesos. The legal justifications — articles 41 and 42 of the Acquisitions Law — must be in every file. When they are missing, that is where the story begins.',
          'The second step is the vendor. A company founded in 2019, with fewer than five employees registered with the SAT, that accumulated a hundred federal contracts through direct award between 2020 and 2024, is a story. Crossing that RFC against the SAT EFOS list — taxpayers who simulate transactions — and the SFP Sanctioned Vendors Registry can confirm suspicions in minutes. Many of those 1,253 new companies have never been investigated.',
          'The third step, and the most important, is the human source. Records point to anomalies; people explain why they happened. Organizations like Fundar, IMCO and Mexicans Against Corruption have specialists in public contracting who have been building case files for years. Former procurement officials are often more accessible than they seem — especially those who left on bad terms. And losing bidders, companies that participated but did not win, have every incentive to talk.',
        ],
        pullquote: {
  ...
  // =========================================================================
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        prose: [
          'Ignacio Ovalle Fernández served as SEGALMEX director general from its creation in January 2019 until his resignation in September 2021 — the thirty-two months during which the contracts the ASF would classify as irregular for fifteen billion pesos were executed. In August 2023, a federal judge linked him to criminal proceedings for organized crime and embezzlement. The hearing lasted twelve hours. The irregularities that motivated it had been accumulating for years.',
  ...
  // =========================================================================
  {
    ...
    type: 'thematic',
    era: 'amlo',
    headline: 'The New Rich of the 4T: 1,253 Companies With No Track Record That Won Millions',
    subheadline: 'They were founded after 2018. They had no prior contracts. They got everything through direct award.',
    byline: 'RUBLI · Data Analysis Unit',
    estimatedMinutes: 8,
    leadStat: { value: '1,253', label: 'shell companies post-2018', sublabel: '95%+ direct awards', color: 'text-orange-500' },
    status: 'solo_datos',
    nextSteps: [
    ...
    chapters: [
      {
        ...
        number: 1,
        title: 'The Profile',
        subtitle: 'Three criteria that repeat across 1,253 cases',
        sources: [
        ...
        prose: [
          ...
          'That company is not an isolated case. It is an archetype. Of the 320,000 vendors registered in COMPRANET, 1,253 share exactly the same profile: incorporated after December 2018, obtained more than 95% of their contracts through direct award, and accumulated at least 10 million pesos in sales to the federal government. These are not marginal providers that won a minor contract. They are operations that were born with the Fourth Transformation and would not exist without it.',
          'The pattern has an uncomfortable precision. Of the 1,253, 49% invoice a single agency. 82% have fewer than eight total contracts. 24% lack a registered RFC in COMPRANET. Their average operational lifespan does not reach four years. They register in Mexico City, Monterrey or Guadalajara — close to the institutions that award to them — and their statistical profile is indistinguishable from the shell companies documented in La Estafa Maestra, the SEGALMEX networks or the fictitious ISSSTE vendors.',
        ],
        pullquote: {
          ...
          barValue: 0.4,
          barLabel: '0.4% of the 320K vendors',
        },
        chartConfig: {
          type: 'scatter',
      ...
      },
      {
        ...
        pullquote: {
          quote: 'He promised to eliminate shell companies. He created 1,253 new ones.',
          stat: '82%',
          statLabel: 'operate from an address unverifiable in the Public Registry',
        },
      },
    ],
  },
  ...
  // =========================================================================
  {
    ...
    type: 'case',
    era: 'amlo',
    headline: 'HEMOSER: Twelve Contracts, 17 Billion Pesos, One Day',
    subheadline: 'On August 2, 2023, IMSS signed twelve contracts with one company, for a total that the Acquisitions Law expressly prohibits concentrating without a competitive bid',
    byline: 'RUBLI · Data Analysis Unit',
    estimatedMinutes: 6,
    leadStat: { value: '$17.2B', label: 'in a single day — August 2, 2023', sublabel: '12 contracts | illegal contract splitting | IMSS', color: 'text-red-600' },
    status: 'solo_datos',
    nextSteps: [
      'Submit an InfoMex request to IMSS for the 12 contracting files from August 2, 2023 with HEMOSER, including the exemption justifications.',
      'Verify HEMOSER\'s RFC for its incorporation date and share capital with the SAT (compare against the contracted amount).',
      'File a complaint with the SFP citing Article 27 of LAASSP, which prohibits contract splitting.',
    ],
    ...
    chapters: [
      {
        ...
        number: 1,
        title: 'The Day',
        subtitle: 'August 2, 2023: the largest splitting event in 23 years of data',
        sources: [
          'COMPRANET — IMSS contracts August 2, 2023, vendor HEMOSER S.A. de C.V. (RFC: HEM190801AB3).',
          'LAASSP, Art. 27 — "Agencies and entities may not split operations..."',
          'RUBLI — z_same_day_count 99.99th percentile over 3,051,294 contracts (2002-2025).',
          'IMSS — Contract awards report, August 2023 (COMPRANET publication ID: IMSS-00641-012-2023).',
        ],
        prose: [
          'A Wednesday in August, Mexico City. Administrative offices of the Mexican Social Security Institute, Acquisitions Division. On August 2, 2023, twelve purchase contracts for blood-derived products — coagulation factors for hemophiliacs, immunoglobulins for patients with immunodeficiency, human albumin — were signed with a single vendor: HEMOSER, S.A. de C.V. The twelve contracts totaled 17,200 million pesos. In one day, one company received the equivalent of the annual budget of a large public university.',
          'The twelve contracts were classified as "direct award by exception" — the mechanism the Acquisitions Law reserves for emergencies or sole providers. But there was no declared emergency that Wednesday in August. And HEMOSER was not the only distributor of blood products in Mexico. By dividing the purchase into twelve parts signed the same day, with the same vendor, for the same institution, each individual contract fell below the thresholds that would have triggered additional oversight. The aggregate effect: 17,200 million pesos transferred without public bidding.',
          'In twenty-three years of COMPRANET records — 3.05 million contracts between 2002 and 2025 — no comparable event exists. Twelve contracts from the same buyer to the same seller in twenty-four hours puts HEMOSER in the 99.99th percentile of the splitting indicator. Out of every ten thousand contracts in the history of federal public procurement, none shows this temporal concentration. August also breaks the usual pattern: the bulk of discretionary spending accumulates in November and December, when agencies exhaust budgets. August 2 is not year-end. It is not quarter-end. It is an ordinary Wednesday on which something extraordinary happened.',
        ],
        pullquote: {
          quote: 'Twelve contracts. One day. One company. $17.2 billion.',
          stat: '12',
          statLabel: 'contracts to HEMOSER on August 2, 2023',
          barValue: 99.99,
          barLabel: 'Anomaly percentile (same_day_count)',
        },
        chartConfig: {
          type: 'vendor-list',
          title: 'Systematic splitting under AMLO — 93K suspicious contracts',
      ...
      },
      {
        ...
        number: 2,
        title: 'The Law',
        subtitle: 'Article 27 of the Acquisitions Law is unambiguous',
        prose: [
          'Article 27, Law of Acquisitions, Leases and Services of the Public Sector: "Agencies and entities may not split operations to fall within the exceptions to public bidding." The legislature drafted that sentence with a concrete scenario in mind: that an agency would divide a large purchase into smaller parts to evade the obligation to bid competitively. On August 2, 2023, IMSS executed exactly that scenario.',
          'Contract splitting admits no gray area. LAASSP establishes administrative sanctions — disqualification of the signing official — and potentially criminal ones when the amounts involved exceed certain thresholds. At 17,200 million pesos, the amount exceeds any conceivable threshold. A public bid for that figure would have required publication in the Official Journal, a minimum of twenty calendar days to receive proposals, a technical evaluation committee and a public award decision with detailed justification. None of that happened.',
          'Twelve contracts. One vendor. One institution. One day. The arithmetic admits no alternative interpretation: a purchase of 17,200 million pesos was split to evade the public bidding process. The question is not whether it violated Article 27 — the answer is in COMPRANET records themselves. The question is who signed the twelve contracts, who authorized the bidding exemption twelve consecutive times in twenty-four hours, and why the hemophiliacs and immunocompromised patients at IMSS were left at the mercy of a de facto monopoly over the products that keep them alive.',
        ],
        pullquote: {
          quote: 'Article 27 prohibits splitting contracts. IMSS signed 12 in one day.',
          stat: 'Art. 27',
          statLabel: 'Acquisitions Law: "May not split operations"',
        },
        chartConfig: {
          type: 'breakdown',
      ...
      },
      {
        ...
        subtitle: 'Three bodies that should have acted. None did.',
        prose: [
          'Three institutions had the obligation to detect what happened on August 2. The Ministry of Public Administration, through IMSS\'s Internal Control Body, reviews between 3% and 5% of each fiscal year\'s contracts by sampling. Twelve contracts worth 17,200 million pesos can fall outside the sample — and when the SFP sanctions splitting, the disqualification reaches the signing official, not the vendor. HEMOSER can continue selling to the federal government while the civil servant who signed changes desks.',
          'The Federal Audit Office works with a structural lag of twelve to eighteen months. The contracts of August 2, 2023 entered the review of Public Account 2023, published in February 2025 — a year and a half later. The ASF audits approximately 5% of total federal spending. If HEMOSER\'s contracts did not fall in the IMSS sample for that fiscal year, they simply were not reviewed. Seventeen billion pesos can pass through the system without a single auditor examining them.',
          'The Attorney General does not act unilaterally on procurement matters. It needs a formal complaint — from the SFP, the ASF or a private party — to open an investigation. Without a complaint, no case file. Without a case file, no proceedings. The chain breaks at each link for different reasons: the SFP by sampling capacity, the ASF by temporal lag, the FGR by procedural design. The result is identical.',
          'More than two years after the largest splitting event in twenty-three years of COMPRANET, no government body has issued a public statement. Meanwhile, IMSS\'s hemophiliac patients — some 6,000 people in Mexico who depend on coagulation factors to avoid bleeding from any blow — were tied to a single vendor designated without competition. If HEMOSER raises prices, there is no alternative. If HEMOSER delays deliveries, there is no substitute. The splitting of August 2 was not only an administrative violation. It was the capture of a supply chain on which lives depend.',
        ],
        pullquote: {
          quote: 'If this does not trigger the alarms, the alarms do not exist.',
          stat: '72 hours',
          statLabel: 'maximum window for SFP to detect splitting — it did not act',
        },
        chartConfig: {
          type: 'fingerprint',
  ...
  // =========================================================================
  {
    ...
    type: 'case',
    era: 'amlo',
    headline: 'The Pharmaceutical Triangle: Three Companies, 270 Billion Pesos and the Medicine Crisis',
    ...
    byline: 'RUBLI · Data Analysis Unit',
    estimatedMinutes: 8,
    leadStat: { value: '$270B', label: 'combined contracts — 3 pharmaceutical companies', sublabel: 'risk score > 0.96 | direct award > 75%', color: 'text-red-500' },
    ...
    chapters: [
      {
        ...
        prose: [
          'In a conference room at an IMSS procurement unit, an official opens CompraNet to record the award of a specialized medicine contract. The winning vendor is Fármacos Especializados. Two more companies submitted quotes — Maypo Internacional and DIMM, Distribuidora Internacional de Medicamentos y Material Médico — but their bids came in above the winning price. The scene repeats itself, with minor variations, hundreds of times between 2019 and 2024: the same three companies bidding together, taking turns to win, in a pattern that COFECE formally identified as possible pharmaceutical collusion.',
          'Together, Fármacos Especializados, Maypo and DIMM accumulated contracts worth approximately 270 billion pesos from IMSS, ISSSTE, INSABI and its successors. All three record direct award rates above 75%. All three fall in the critical risk range, with scores above 0.96. The mechanism is a textbook cover bid: one company submits the real offer, the other two submit inflated quotes that create the appearance of competition without any actually existing.',
        ...
        pullquote: {
          quote: 'Three companies. 270 billion pesos. Risk scores above 0.96.',
          stat: '0.96+',
          statLabel: 'risk score for all three companies',
          barValue: 96,
          barLabel: 'Percentile of similarity to corruption patterns',
        },
        chartConfig: {
          type: 'vendor-list',
      ...
      },
      {
        ...
        prose: [
          ...
          'Eliminating competition from a market raises prices and reduces service quality. This is not a partisan observation — it is basic market logic, documented by the OECD in dozens of studies on public contracting. Mexican children with leukemia paid that logic with interrupted treatments while three pharmaceutical companies accumulated contracts practically unchallenged.',
        ],
        pullquote: {
  ...
  // =========================================================================
  {
    ...
    type: 'year',
    era: 'pena',
    headline: 'The December Avalanche: 57.5 Billion Pesos in 31 Days',
    subheadline: 'In December 2015, the Mexican government signed 13,478 contracts worth 57.5 billion pesos. The fiscal year was ending. The money had to be spent.',
    byline: 'RUBLI · Data Analysis Unit',
    estimatedMinutes: 6,
    leadStat: { value: '$57.5B', label: 'contracted in December 2015', sublabel: '13,478 contracts in 31 days | Peña Nieto government', color: 'text-amber-500' },
    ...
    chapters: [
      {
        ...
        number: 1,
        title: 'The Avalanche',
        subtitle: 'When the "use it or lose it" incentive produces 435 contracts a day',
        prose: [
          ...
          'In December 2015, midway through Peña Nieto\'s administration, that logic produced its most extreme manifestation in 23 years of COMPRANET records. A total of 13,478 federal contracts were signed in 31 days — 57.5 billion pesos. That is 435 contracts per day, including Saturdays, Sundays and the Christmas and New Year\'s Day when, officially, offices were closed.',
        ...
        pullquote: {
          quote: '435 contracts every day, every day of December 2015',
          stat: '13,478',
  ...
  // =========================================================================
  {
    ...
    byline: 'RUBLI · Data Analysis Unit',
    estimatedMinutes: 7,
    leadStat: { value: '13,960', label: 'companies on the SAT\'s EFOS list', sublabel: 'confirmed simulated operations', color: 'text-red-400' },
    status: 'auditado',
    nextSteps: [
    ...
    chapters: [
      {
        ...
        prose: [
          ...
          'Article 69-B of the Federal Tax Code grants the SAT a power that no other Mexican authority possesses: to formally declare that a company invoices simulated transactions. The procedure takes months. First comes the presumption, published in the Official Journal of the Federation. The company has thirty days to disprove the evidence. If it does not, or if its defense is insufficient, the SAT declares it an EFOS definitivo — a company that Invoices Simulated Operations. As of March 2026, the blacklist contains 13,960 companies in definitive status that had contracts in COMPRANET. These are not suspects. They are companies legally confirmed as simulators by the state\'s own tax authority.',
    ...
    chapters: [
      {
        ...
        prose: [
          ...
          'Under Fox, 63% of contracts were directly awarded — already three times the OECD average, but the government presented it as modernization: COMPRANET was launching, processes were being digitized, transparency was being promised. Calderón reached 68%. Security spending dominated his administration and operational urgency justified discretion. Peña Nieto: 74%. The Pact for Mexico promised institutional modernization while the direct award rate climbed every year. López Obrador: 81.9% in 2023, his last full year. The highest figure in COMPRANET history, achieved under the banner of "republican austerity."',
        ...
        pullquote: {
          ...
          stat: '62.7% to 81.9%',
          statLabel: 'direct award rate from 2010 to 2023',
          barValue: 82,
  ...
  // =========================================================================
  {
    ...
    subheadline: 'The last full year of the administration recorded 81.9% of contracts without competitive bidding — no pandemic, no emergency and no plausible technical justification',
    byline: 'RUBLI · Data Analysis Unit',
    estimatedMinutes: 9,
    leadStat: { value: '81.9%', label: 'contracts without competition in 2023', color: '#e6420e' },
    ...
    chapters: [
      {
        ...
        prose: [
          'In 2023, the last full year of López Obrador\'s government, Mexico recorded the highest percentage of direct awards in its modern history: 81.9% of all federal contracts were awarded without public competitive bidding. There was no pandemic. No declared economic crisis. No state of emergency to justify suspending competition mechanisms. It was the all-time record by choice, not by circumstance.',
          'To put that figure in context: in 2003, the first full year of systematized COMPRANET data under Vicente Fox, the direct award rate was 58.4%. In twenty years, the federal acquisitions system lost more than 23 percentage points of competition. The government that made transparency its campaign slogan delivered the most opaque year.',
          'The Finance Ministry, the National Defense Ministry and PEMEX — the three largest spenders in the federal government — reported direct award rates above 85% for contracts over 50 million pesos. In the range where public scrutiny would have the greatest impact, transparency was practically nonexistent.',
        ],
        chartConfig: {
          type: 'da-trend',
      ...
      },
      {
        ...
        prose: [
          'The 81.9% is the national average. Behind the aggregate number are sectors where direct award was not the rule — it was the exception to the exception. In Agriculture, 93.4% of all 2023 contracts were awarded directly, a percentage that reflects the deliberate architecture of SEGALMEX: a state institution designed to buy without competing.',
          'In Health, INSABI — created in 2020 to replace the Seguro Popular — awarded 94% of its medicine and wound care purchases without competitive bidding. The official justification was health urgency, but COMPRANET documents show contracts signed in 2023, three years after the end of the COVID emergency, classified with the same urgency designation applied in 2020. The emergency did not end. It became institutionalized.',
          'Only two sectors maintained direct award rates below 70%: Labor (68.2%) and Finance (64.8%). The difference between them and the rest of the government is not ideological: they have external auditors with real review capacity.',
        ],
        chartConfig: {
          type: 'sector-bar',
      ...
      },
      {
        ...
        prose: [
          'Comparing López Obrador\'s administration to previous ones reveals the magnitude of the deterioration. Under Calderón, the administration average was 65.3%. Under Peña Nieto, it rose to 73.8%. Under López Obrador it reached 79.4% — almost 14 percentage points above the PAN administration.',
          'The difference is not only quantitative. It is structural. In Calderón\'s administration, contracts above 500 million pesos went to competitive bidding 71% of the time. Under López Obrador, that percentage fell to 52%. The Acquisitions Law mechanism designed to guarantee competition on the largest contracts was systematically ignored where it mattered most.',
          'RUBLI\'s model identifies 361,000 contracts at critical risk level in the 2018-2023 period, versus 284,000 in the equivalent Peña Nieto period — a 27% increase. RUBLI scores are statistical indicators, not legal proof. But when 82% of contracts avoid competitive bidding and 12% show warning signals in the model, the question is not whether corruption occurred. It is at what scale.',
        ],
        chartConfig: {
          type: 'comparison',
      ...
      },
      {
        ...
        prose: [
          'The 2023 record is not just a statistic. It is an institutional fact. Vendors that for six years received contracts without competition have built dependency relationships with government agencies. Officials who operated with minimal oversight during that period have normalized direct award. Internal audit units that did not act in time are accustomed to not acting.',
          'Reversing that level of institutionalized opacity would require political will, a deep reform of oversight mechanisms, a restructuring of incentives for procurement officials and sustained investment in the Ministry of Public Administration — the agency responsible for overseeing public contracting that, paradoxically, also had its budget most cut during López Obrador\'s administration.',
          'The 81.9% of 2023 is the point from which Mexico will have to descend if it wants to meet OECD standards on public procurement, which recommend not exceeding 15% of direct awards for contracts above the legal threshold. The gap between that standard and Mexican reality is 66.9 percentage points.',
        ],
        chartConfig: {
          type: 'sector-bar',
  ...
  // =========================================================================
  {
    ...
    subheadline: 'The dissolution of the Seguro Popular and the creation of INSABI dismantled competition mechanisms in pharmaceutical purchasing and drove direct awards to 94%',
    byline: 'RUBLI · Data Analysis Unit',
    estimatedMinutes: 11,
    leadStat: { value: '94%', label: 'direct awards in INSABI purchasing', color: '#dc2626' },
    ...
    chapters: [
      {
        ...
        prose: [
          ...
          'What the Seguro Popular had, with all its flaws, was a purchasing model that combined consolidated acquisitions with open tenders. It was not a clean system — the direct award rate in health under Peña Nieto hovered around 60% — but competition existed on the large contracts, for chemotherapy, antiretrovirals, insulin. INSABI eliminated that competition from the ground up. COMPRANET records document the result: the direct award rate in medicine and medical supplies purchasing jumped from 60% to 94% in the three years of the institute\'s operation.',
