    ...
    chapters: [
      {
        ...
        prose_es: [
          'El modelo de riesgo v0.8.5 de RUBLI califica cada contrato federal en una escala de 0 a 1 calibrada contra 1,422 casos documentados de corrupción. El modelo desconoce el tamaño del contrato al asignar las calificaciones — procesa características como concentración de proveedores, volatilidad de precios y mecanismo de contratación. Sin embargo, cuando los contratos se agrupan por tamaño después de la calificación, la relación entre tamaño y riesgo es casi monótona.',
    ...
    chapters: [
      {
        ...
        prose: [
          'RUBLI\'s v0.8.5 risk model was not calibrated to any single administration. It was trained on 1,422 documented corruption cases spanning multiple presidencies and scores contracts based on their structural similarity to known-bad patterns: vendor concentration, price volatility, single-bidder conditions, network membership, institution diversity, and procurement mechanism. The model has no partisan attachment and no political knowledge. It sees only patterns.',
