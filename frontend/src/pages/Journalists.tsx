...
import { Search, Shield, BarChart3, Download, Copy, Check, ExternalLink, ArrowRight, BookOpen, AlertTriangle } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#faf9f6' }}>
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        {/* ---------------------------------------------------------------- */}
        {/* SECTION 2: Key Findings (Story Hook Cards) */}
        {/* ---------------------------------------------------------------- */}
        <motion.section
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
